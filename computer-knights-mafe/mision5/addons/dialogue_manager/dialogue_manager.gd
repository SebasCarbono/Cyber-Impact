...
const DialogueResource = preload("res://mision5/addons/dialogue_manager/dialogue_resource.gd")
const DialogueLine = preload("res://mision5/addons/dialogue_manager/dialogue_line.gd")
const DialogueResponse = preload("res://mision5/addons/dialogue_manager/dialogue_response.gd")

const DMConstants = preload("res://mision5/Kruskal/Scenes/constants.gd")
const Builtins = preload("res://mision5/addons/dialogue_manager/utilities/builtins.gd")
const DMSettings = preload("res://mision5/addons/dialogue_manager/settings.gd")
const DMCompiler = preload("res://mision5/addons/dialogue_manager/compiler/compiler.gd")
const DMCompilerResult = preload("res://mision5/addons/dialogue_manager/compiler/compiler_result.gd")
const DMResolvedLineData = preload("res://mision5/addons/dialogue_manager/compiler/resolved_line_data.gd")
